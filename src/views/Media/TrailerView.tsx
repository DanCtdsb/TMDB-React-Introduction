...
export const TrailerView = () => {
  ...
  const data = useGetData<TrailerResponse>(
    `${BASE_ENDPOINT}/${mediaType}/${id}/videos`,
    {},
    [id, mediaType],
  );
  console.log(data);
  ...
  const officialTrailers = allVideos
    .filter(
      (video) =>
        video.site === "YouTube" &&
        video.type === "Trailer" &&
  ...
  return (
    <div className="flex flex-col gap-6 pt-6">
      <h2 className="text-xl font-semibold text-white">Trailers</h2>
